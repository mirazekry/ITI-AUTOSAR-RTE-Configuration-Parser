...
class InterfaceParser(BaseParser):
    ...
    PackagesSource = [Tag.inputSenderRecieverInterface,Tag.inputSRDataElement,
                        Tag.inputTypeReference,Tag.inputClientServerInterface,
                            Tag.inputCSOperation,Tag.inputOpArgument,Tag.inputOpArgumentDirection,
                                Tag.inputPossibleError,Tag.inputPossibleErrorRef]
    ...
    def getSenderRecieverInterfaces(self):
        ...
        return SenderRecieverInterfaces,ElementPackagesID[Tag.inputSenderRecieverInterface]
    ...
    def getClientServerInterfaces(self):
        ...
        return ClientServerInterfaces,ElementPackagesID[Tag.inputClientServerInterface]
