...
class ElementParser(BaseParser):
  ...
  PackagesSource = [Tag.Package,Tag.inputImplementationType,
                      Tag.inputTypeCategory,Tag.inputImplementationTypeElement,
                        Tag.inputArraySize,Tag.inputArraySizeSemantics,Tag.inputBaseTypeReference,
                          Tag.inputImplementationTypeReference,Tag.inputSWbaseTypes,Tag.inputBaseTypeSize]
